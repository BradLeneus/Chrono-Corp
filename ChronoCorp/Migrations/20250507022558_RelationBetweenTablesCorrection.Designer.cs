...
namespace ChronoCorp.Migrations
{
    ...
    [Migration("20250507022558_RelationBetweenTablesCorrection")]
    partial class RelationBetweenTablesCorrection
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ChronoCorp.Model.CeduleQuart", b =>
                {
                    ...
                    b.HasOne("ChronoCorp.Model.TypeQuart", null)
                        .WithMany("CeduleQuarts")
                        .HasForeignKey("TypeQuartId");
